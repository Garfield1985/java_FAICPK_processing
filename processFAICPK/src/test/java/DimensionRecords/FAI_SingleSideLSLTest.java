 ...
 * @author fatca
 */
public class FAI_SingleSideLSLTest {
    ...
    public FAI_SingleSideLSLTest() {
        ...
        this.inspecDUT = new FAI_SingleSideLSL("FAI1", inSpecData);
        this.OOSUSLDUT = new FAI_SingleSideLSL("FAI1", OOSUSLData);
        this.OOSLSLDUT = new FAI_SingleSideLSL("FAI1", OOSLSLData);
        this.boundaryDUT = new FAI_SingleSideLSL("FAI1", boundaryData);
    }
    ...
    /**
     * Test of in_spec method, of class FAI_SingleSideLSL.
     */
    @Test
    public void testIn_spec() {
        System.out.println("in_spec");
        ISpecification spec = this.spec;
        FAI_SingleSideLSL instance = null;
//        boolean expResult = false;
//        boolean result = instance.in_spec(spec);
        
        assertAll("Single Side-LSL",
                ()-> assertEquals(true, inspecDUT.in_spec(spec)),
                ()-> assertEquals(true, OOSUSLDUT.in_spec(spec)),
                ()-> assertEquals(false, OOSLSLDUT.in_spec(spec)),
